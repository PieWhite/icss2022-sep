...
public interface ICSSListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ICSSParser#selectorRule}.
	 * @param ctx the parse tree
	 */
	void enterSelectorRule(ICSSParser.SelectorRuleContext ctx);
	/**
	 * Exit a parse tree produced by {@link ICSSParser#selectorRule}.
	 * @param ctx the parse tree
	 */
	void exitSelectorRule(ICSSParser.SelectorRuleContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link ICSSParser#primaryExpression}.
	 * @param ctx the parse tree
	 */
	void enterPrimaryExpression(ICSSParser.PrimaryExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link ICSSParser#primaryExpression}.
	 * @param ctx the parse tree
	 */
	void exitPrimaryExpression(ICSSParser.PrimaryExpressionContext ctx);
}