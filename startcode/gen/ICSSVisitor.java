...
public interface ICSSVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ICSSParser#selectorRule}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSelectorRule(ICSSParser.SelectorRuleContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ICSSParser#primaryExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimaryExpression(ICSSParser.PrimaryExpressionContext ctx);
}