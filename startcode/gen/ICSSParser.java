// Generated from C:/Users/Allan/Documents/GitHub/icss2022-sep/startcode/src/main/antlr4/nl/han/ica/icss/parser/ICSS.g4 by ANTLR 4.13.2
...
public class ICSSParser extends Parser {
	...
	public static final int
		...
		RULE_expression = 8, RULE_primaryExpression = 9;
	private static String[] makeRuleNames() {
		return new String[] {
			"stylesheet", "statement", "selectorRule", "selector", "variableAssignment", 
			"ifClause", "elseClause", "declaration", "expression", "primaryExpression"
		};
	}
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public SelectorRuleContext selectorRule() {
			return getRuleContext(SelectorRuleContext.class,0);
		}
	...
	public static class SelectorRuleContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).enterSelectorRule(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).exitSelectorRule(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ICSSVisitor ) return ((ICSSVisitor<? extends T>)visitor).visitSelectorRule(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final SelectorRuleContext selectorRule() throws RecognitionException {
		...
		enterRule(_localctx, 4, RULE_selectorRule);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class PrimaryExpressionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).enterPrimaryExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).exitPrimaryExpression(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ICSSVisitor ) return ((ICSSVisitor<? extends T>)visitor).visitPrimaryExpression(this);
			else return visitor.visitChildren(this);
		}
	}
